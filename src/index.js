import './assets/fonts/fonts-index.scss';
import './index.scss';
...
import { faVideo, faCopyright } from '@fortawesome/free-solid-svg-icons';

library.add(faPlayCircle, faStopCircle, faVideo, faCopyright);
